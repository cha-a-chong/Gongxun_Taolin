...
Hardware/Run/%.o Hardware/Run/%.su Hardware/Run/%.cyclo: ../Hardware/Run/%.c Hardware/Run/subdir.mk
...
clean: clean-Hardware-2f-Run

clean-Hardware-2f-Run:
	-$(RM) ./Hardware/Run/Run.cyclo ./Hardware/Run/Run.d ./Hardware/Run/Run.o ./Hardware/Run/Run.su

.PHONY: clean-Hardware-2f-Run
