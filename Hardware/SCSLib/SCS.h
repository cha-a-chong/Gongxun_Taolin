...
#ifndef SCSLIB_SCS_H_
#define SCSLIB_SCS_H_
...
extern int syncReadPacketTx(uint8_t ID[], uint8_t IDN, uint8_t MemAddr,
		uint8_t nLen); //同步读指令包发送
...
extern void writeBuf(uint8_t ID, uint8_t MemAddr, uint8_t *nDat, uint8_t nLen,
		uint8_t Fun);
