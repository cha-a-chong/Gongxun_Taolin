 ...
 * @retval   地址 + 功能码 + 命令状态 + 校验字节
 */
void Emm_V5_Vel_Control(uint8_t addr, uint8_t dir, uint16_t vel, uint8_t acc,
		bool snF) {
...
void Emm_V5_Read_Encoder(uint8_t addr)                //实测2731大概对应实际1cm，65536是一圈
{
